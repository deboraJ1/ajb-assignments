...
public class Oxygen implements AtomI {
    ...
    public Oxygen(Point3D location, double temperatureFactor) {
        if (location != null) {
            this.location = new SimpleObjectProperty<>(location);
        }
        else{
            throw new InvalidParameterException("Point of an atom can not be null. Please specify where this Oxygen shall be located.");
        }
        this.tempFactor = temperatureFactor;
        //default:
        this.name = new SimpleStringProperty("Oxygen");
        this.letter = new SimpleStringProperty("O");
        this.radius = new SimpleIntegerProperty(66);
