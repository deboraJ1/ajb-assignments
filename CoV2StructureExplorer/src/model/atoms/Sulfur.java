...
public class Sulfur implements AtomI{
    ...
    public Sulfur(Point3D location, double temperatureFactor) {
        if (location != null) {
            this.location = new SimpleObjectProperty<>(location);
        }
        else{
            throw new InvalidParameterException("Point of an atom can not be null. Please specify where this Sulfur shall be located.");
        }
        this.tempFactor = temperatureFactor;
        //default:
        this.name = new SimpleStringProperty("Sulfur");
        this.letter = new SimpleStringProperty("S");
        this.radius = new SimpleIntegerProperty(88);
